...
export default function SimulationDemo() {
  return (
    <Layout
      ...
      description="Research-oriented cockpit, spacecraft configuration workflow, telemetry interface, and simulation demonstration of the Spaceflight Dynamics Framework"
    >
      <main className="simulationPage">
        ...
        <section className="simSection">
          ...
          <p className="simIntroText">
            The <strong>Spaceflight Dynamics Framework (SDF)</strong> is designed
            as a research-oriented simulation environment for spacecraft dynamics,
            descent guidance, control algorithms, propulsion system evaluation,
            and telemetry-driven analysis.
          </p>

          <p className="simIntroText">
            Before starting a simulation run, users select a spacecraft configuration
            from a set of JSON-defined vehicle profiles. Each configuration defines
            the physical, propulsion-related, and controller-relevant parameters used
            by the C++ simulation backend.
          </p>
          ...
          <div className="simCard">
            ...
            <p className="simCaption">
              ...
              Each vehicle profile is defined externally and contains mass properties,
          ...
          <p className="simDescription">
            ...
            engine. This allows new spacecraft variants, propulsion layouts, fuel tank
            architectures, and test scenarios to be introduced without modifying the core
            simulation code.
          </p>
        ...
        <section className="simIntro">
          ...
          <p>
            ...
            behavior, command response, and vehicle state evolution.
          </p>

          <p>
            All displayed quantities are computed by the underlying C++ physics model and
            updated in real time through the frontend telemetry path.
          </p>
        </section>
        ...
        <section className="simSection">
          <div className="simCard">
            ...
            <p className="simCaption">
              ...
              The cockpit visualizes Reaction Control System activity at multiple abstraction
              levels: the Landing View indicates whether RCS activity is present in the vehicle
              state display, the STATUS block reports how many configured RCS thrusters are
              currently active, and the ENGINE block exposes thruster-level thrust information
              when individual RCS engines are firing.
            </p>
          </div>
        </section>
        ...
        <section className="simSection">
          ...
          <p className="simDescription">
            ...
            Instead of only presenting a simplified landing animation, the interface exposes
            vehicle state, propulsion state, control activity, and controller-relevant telemetry
            in a way that supports debugging, controller comparison, and future data export.
          </p>

          <div className="interfaceBlock">
            <h3>NAV — Navigation State</h3>
            <p>
              The navigation section displays the spacecraft&apos;s current kinematic state in
              the local navigation frame. The interface is prepared around the ENU convention:
          ...
          <div className="interfaceBlock">
            ...
            <p>
              ...
              altitude display to a lightweight 2.5D situational view. It shows the spacecraft
            ...
            <p>
              ...
              yaw indication, and a compact state overlay. The state overlay also indicates
              RCS activity, allowing the user to immediately see whether translational control
              thrusters are contributing to the current vehicle motion.
            </p>
          </div>
          ...
          <div className="interfaceBlock">
            ...
            <p>
              In addition, the status block reports the number of active RCS thrusters
        ...
        <section className="simSection">
          ...
          <p className="simDescription">
            SDF is intended to support the development and evaluation of spacecraft
            guidance and control strategies. The cockpit interface therefore focuses on
            telemetry visibility, reproducibility, observability, and system behavior
            analysis rather than visual realism alone.
          </p>

          <p className="simDescription">
            Planned extensions include structured simulation data export, controller
            comparison workflows, and plotting tools for post-run analysis. Relevant
            quantities include altitude, vertical velocity, lateral drift, fuel consumption,
            thrust commands, tank usage, RCS activity, controller state, and final touchdown
            conditions.
          </p>

          <p className="simDescription">
            The current demonstration remains a lunar descent scenario, but it now acts as
            a validation use case for the broader Spaceflight Dynamics Framework rather than
