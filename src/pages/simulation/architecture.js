        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              frontend navigation, settings access, and control / coordinate help access.
            </li>
            <li>
            ...
            <li><strong>CoordinateHelpPage:</strong> Frontend-only coordinate-frame reference for MCI, MCMF, MSC, ENU, LVLH and SBF. 
              It visualizes frame conventions but performs no coordinate transformation itself.
            </li>
            <li>
      ...
      <hr />
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              translational and rotational RCS commands to individual thruster commands.
              Translational commands are allocated by comparing the requested SBF force
              direction with each thruster's configured thrust direction. Rotational
              commands are allocated from the torque direction generated by each thruster,
              using its mounting position, the current spacecraft center of mass, and its
              thrust direction. The resulting moment direction is derived from
              <code> r × F</code>, allowing attitude-control thrusters to be selected from
              spacecraft geometry rather than hard-coded roll, pitch, or yaw assignments.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              Translational RCS commands are allocated according to thruster force direction,
              while rotational RCS commands are allocated from the torque direction resulting
              from thruster position, current spacecraft center of mass, and thrust direction.
            </li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              <strong>Frontend/Backend Decoupling:</strong> Frontend-facing communication is isolated through explicit command and telemetry DTOs. 
              Future ROS2 integration can reuse this established transport-independent boundary.
            </li>
            <li>
